...
namespace Npgs::Astro
{
    ...
    private:
        static EParseState ParseStellarType(char Char, EStellarType& StellarType, ESpectralClass& HSpectralClass, std::size_t& Index);
        static EParseState ParseSpectralClass(char Char, ESpectralClass& SpectralClass, std::size_t& Index);
        static EParseState ParseWolfRayetStar(char Char, ESpectralClass& SpectralClass, std::size_t& Index);
        static EParseState ParseWhiteDwarf(char Char, ESpectralClass& SpectralClass, std::size_t& Index);
        static EParseState ParseWhiteDwarfEx(char Char, char PrevChar, ESpectralClass& SpectralClass, std::size_t& Index);
        static EParseState ParseLuminosityClass(char Char, ELuminosityClass& LuminosityClass, std::size_t& Index);
        static EParseState ParseLuminosityClassI(char Char, ELuminosityClass& LuminosityClass, std::size_t& Index);
        static EParseState ParseLuminosityClassIa(char Char, ELuminosityClass& LuminosityClass);
        static EParseState ParseLuminosityClassII(char Char, ELuminosityClass& LuminosityClass);
        static EParseState ParseLuminosityClassV(char Char, ELuminosityClass& LuminosityClass);
        static EParseState ParseSpecialMark(char Char, char NextChar, FSpecialMarkDigital& SpecialMark, std::size_t& Index);
        static std::string SpectralClassToString(ESpectralClass SpectralClass, float Subclass);
        static std::string LuminosityClassToString(ELuminosityClass LuminosityClass);
