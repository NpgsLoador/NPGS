...
#define NpgsError(...)        ::Npgs::FLogger::GetClientLogger()->error(__VA_ARGS__)
#define NpgsInfo(...)         ::Npgs::FLogger::GetClientLogger()->info(__VA_ARGS__)
#define NpgsTrace(...)        ((void)0)
#define NpgsWarn(...)         ::Npgs::FLogger::GetClientLogger()->warn(__VA_ARGS__)

#else

#define NpgsCoreCritical(...) ((void)0)
#define NpgsCoreError(...)    ((void)0)
#define NpgsCoreInfo(...)     ((void)0)
#define NpgsCoreTrace(...)    ((void)0)
#define NpgsCoreWarn(...)     ((void)0)

#define NpgsCritical(...)     ((void)0)
#define NpgsError(...)        ((void)0)
#define NpgsInfo(...)         ((void)0)
#define NpgsTrace(...)        ((void)0)
#define NpgsWarn(...)         ((void)0)
