...
namespace Npgs
{
    ...
    private:
        ...
        Math::TBernoulliDistribution<>   AsiFiltedProbability_;
        Math::TBernoulliDistribution<>   DestroyedByDisasterProbability_;
        Math::TBernoulliDistribution<>   LifeOccurrenceProbability_;
