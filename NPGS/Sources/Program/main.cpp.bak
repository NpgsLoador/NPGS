...
int main() {
    ...
    using namespace Npgs::Runtime::Thread;
    using namespace Npgs::System::Generator;
    using namespace Npgs::Util;

    FLogger::Initialize();
    FThreadPool::GetInstance();
    ...
    FStellarGenerator sg({ seed });
    FStellarGenerator::FBasicProperties b1{ FStellarGenerator::EStellarTypeGenerationOption::kRandom, FStellarGenerator::EMultiplicityGenerationOption::kBinaryFirstStar, 5e6f, 0.0f, 1.0f };
    ...
    FOrbitalGenerator og({ seed/*1681068171*/ });
